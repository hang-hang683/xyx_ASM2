...
from src.AMSUnet import AMSUnet as UNet
...
def main(args):
    ...
    # 用来保存训练以及验证过程中信息
    results_file = "results{}_DRIVE.txt".format(datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.save_best is True:
            torch.save(save_file, "save_weights/DRIVE.pth")
        else:
